...
Use the [Decode
process](https://github.com/ellennickles/code-your-way-s26/blob/main/decode.md)
and analyze the input code and predict the visual output:

4. [Decode
   1](https://github.com/ellennickles/code-your-way-s26/blob/main/week3/decode1.js)
5. [Decode
   2](https://github.com/ellennickles/code-your-way-s26/blob/main/week3/decode2.js)
