...
- Review arrays - UPDATE
  - [Part 1]()
  - [Part 2]()
  - [Part 3]() (custom palette generator)
- Review functions - UPDATE
  - [Review functions]()
  - [Review functions with nested loop (grid)]()
...
- Extending our work with loops and patterns (last week of grids?!),
...
- Additional inspiration:
  - Featured artists in the [Class Slides]() - LINK TO BE ADDED
  ...
  - Student examples:
    ...
    - [Kristina](https://editor.p5js.org/enickles/full/eoP-IFRTa)
    - [Athena](https://editor.p5js.org/enickles/full/uJHDQVkWx)
...
#### Part 1: Keep Going - ADD A PEP TALK, Showing up each week is the actual work, Your doing it
